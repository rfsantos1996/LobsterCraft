 ...
 */
public class PlayerJoinsCityEvent extends Event implements Cancellable {
    ...
    private CityStructure.JoinCityResponse result = CityStructure.JoinCityResponse.SUCCESSFULLY_JOINED_CITY;
     ...
     */
    public PlayerJoinsCityEvent(@NotNull final OfflinePlayer offlinePlayer, @NotNull final CityStructure cityStructure) {
    ...
    public CityStructure.JoinCityResponse getResult() {
        return result;
    }

    public void setResult(@NotNull CityStructure.JoinCityResponse result) {
        this.result = result;
    }
