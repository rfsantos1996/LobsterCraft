package com.jabyftw.pacocacraft2;

import com.comphenix.protocol.ProtocolLibrary;
import com.comphenix.protocol.ProtocolManager;
import com.jabyftw.pacocacraft.ConfigValue;
import com.jabyftw.pacocacraft.util.BukkitScheduler;
import com.jabyftw.pacocacraft.util.ConfigurationFile;
import com.jabyftw.pacocacraft2.block.block_protection.BlockProtectionService;
import com.jabyftw.pacocacraft2.block.xray_protection.XrayProtectionService;
import com.jabyftw.pacocacraft2.location.TeleportService;
import com.jabyftw.pacocacraft2.login.UserLoginService;
import com.jabyftw.pacocacraft2.login.UserProfile;
import com.jabyftw.pacocacraft2.login.ban.BanService;
...
public class PacocaCraft extends JavaPlugin {
     ...
     */
    public static Set<PlayerHandler> getOnlinePlayers() {
        return playerMap.values().stream().filter((playerHandler -> playerHandler.getProfile(UserProfile.class).isLoggedIn())).collect(Collectors.toSet());
    }
