...
public class WorldController {
    ...
    public void updateWorldList() {
        ...
        try {
            ...
            if (!pendingWorldInsertion.isEmpty()) { // Insert pending worldsToHandle
                // Prepare query
                StringBuilder stringBuilder = new StringBuilder("INSERT INTO `minecraft`.`worlds` (`worldId`, `worldName`) VALUES ");
            ...
            if (!pendingWorldDeletion.isEmpty()) { // Delete pending worldsToHandle
                // Prepare query
